<template>
    <div class="w-full max-w-sm overflow-hidden bg-white rounded-lg shadow-lg">
        <img class="object-cover object-center w-full h-56" :src="props.user.imageUrls" alt="avatar">
...
const props = defineProps({
    user: {
        ...
        default: {
            ...
            "imageUrls": "https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80"
