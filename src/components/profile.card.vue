...
const props = defineProps({
  user: {
    ...
    default: {
      ...
      imageUrls:
        'https://storage.googleapis.com/download/storage/v1/b/ttoproj-store.appspot.com/o/2565-10-27%20171551871-WIN_20211227_12_33_30_Pro.jpg?generation=1666865754411623&alt=media'
    }
  }
})
const getAge = (date) => {
